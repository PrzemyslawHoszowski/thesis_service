...
class Identity(models.Model):
    ...
    verification_status = models.IntegerField(choices=VerificationStatus.choices,
                                              default=VerificationStatus.ADDRESS_VERIFICATION,
...
class Certificate(models.Model):
    ...
    def create(cls, public_key: str, identity: Identity):
        ...
        cert.get_subject().CN = " ".join(
            [identity.user.first_name, identity.user.last_name, identity.blockchain_address])
